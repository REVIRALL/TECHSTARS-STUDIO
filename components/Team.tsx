...
const members: TeamMember[] = [
  ...
  },
  {
    ...
    name: '沼倉 隆平',
    role: 'AIスペシャリスト',
    // ★「1000万円クラスの案件を1ヶ月で20本受注」は月間2億円の主張になる。
    //   景表法7条2項の不実証広告規制で、契約書・入金記録による裏付けの提出を
    //   求められて出せない性質の数字なので落とした。裏付けが出せるなら戻してよい。
    bio: 'AI駆動開発の実務家。受託開発の現場でAIを用いた設計・実装・提案を行い、本プログラムのカリキュラムを設計。',
    image: '/numakura.jpg',
  },
];
