...
export const FAQS: Faq[] = [
  ...
  {
    q: '一般的なプログラミングスクールやプログラミング教室と何が違いますか？',
    a: '通学型のプログラミング教室や従来のプログラミングスクールは、言語の文法を覚えてコードを自分で書けるようになることを目指し、2〜3年かかることも珍しくありません。TECHSTARS STUDIOは生成AIに指示を出して開発するため、覚えるのはAIの使い方だけです。オンライン完結のAIスクールで、7日間で動くシステムを3つ作りきります。',
  },
  {
  ...
  {
    q: '社会人や学生でも受講できますか？地方に住んでいても大丈夫ですか？',
    a: '受講できます。講義は1回60〜90分で、残りは自分のペースで進める自習日なので、本業のある社会人や学生でも進められます。通学の必要がないオンラインスクールで、マンツーマン指導のため日本全国どこからでも同じ内容を受けられます。',
  },
  {
    q: '受講に必要なものは何ですか？',
  ...
  /*
   * ここから下は「同じことを別の言葉で探している人」に届けるための設問。
   * 検索エンジンはひらがな・カタカナ・全角半角のゆれは吸収するが、
   * 「プログラミングスクール」と「AI開発スクール」のように語彙が違うものは
   * 結び付けてくれない。羅列ではなく、実際に聞かれる問いの形で1回ずつ触れる。
   * 判断基準は「その質問に答える価値があるか」で、無いものは書かない。
   */
  {
    q: 'アクセラレーターの Techstars と関係はありますか？',
    a: 'ありません。米国のスタートアップアクセラレーター Techstars とは無関係の別事業者です。当社の TECHSTARS STUDIO（テックスターズスタジオ）は、株式会社リバイラルが運営する日本国内向けのAI開発スクールで、社名は「TECH（技術）× 星」に由来します。',
  },
  {
    q: '1週間でエンジニアに転職できるということですか？',
    a: '転職を保証するものではありません。1週間（7日間）で身につくのは「AIに指示を出して動くものを作りきる力」で、修了時点でポートフォリオサイト・業務自動化ツール・データベース連携Webアプリの3つが手元に残ります。転職活動でも副業の案件獲得でも、この3つが実物の証明になります。',
  },
  {
    q: '生成AIやChatGPTの使い方講座とは違うのですか？',
    a: '違います。ChatGPTやGeminiの使い方そのものではなく、Claude Codeを使って実際に動くシステムを作り、本番環境にデプロイするところまでを扱います。人工知能の一般教養ではなく、AI駆動開発の実務手順を身につける講座です。',
  },
  {
    q: 'ノーコードツールを学ぶブートキャンプですか？',
    a: 'ノーコードツールは使いません。生成AIが実際のコード（HTML・CSS・JavaScript・バックエンド）を書くので、ノーコードの制約を受けずに作れるものが決まります。7日間の短期集中という点ではブートキャンプに近い形式ですが、扱うのは本物のコードです。',
  },
];
...
export const ROUTES: RouteMeta[] = [
  {
    ...
    path: '/',
    file: 'index.html',
    title: '未経験から7日間でプロへ｜AI開発スクール TECHSTARS STUDIO',
    description:
